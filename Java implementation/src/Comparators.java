...
public class Comparators {
	...
	/**
	 * En las expulsiones devuelve siempre 1 que es distinto de <=0 por ende no
	 * expulsa En las priority, siempre devuelve positivo enstonces hace fifo
	 * 
	 * @return
	 */
	...
	/**
	 * En las expulsiones devuelve siempre QUANTUM - executed time, si se llega
	 * a quantum expulsa En las priority, siempre devuelve QUANTUM - 0 que es
	 * positivo enstonces hace fifo
	 * 
	 * @return
	 */
	private static Comparator<Executable> comparatorRR(Integer q) {
		return new Comparator<Executable>() {
			...
			@Override
			public int compare(Executable o1, Executable o2) {
				if (o1.getExecutionTime() == 0 && o2.getExecutionTime() == 0) // solo
																				// ocurre
																				// en
																				// expel
																				// evaluation
	...
	/**
	 * En las expulsiones devuelve siempre SRT1 - SRT2 En las priority, siempre
	 * devuelve SRT1 - SRT2 que es positivo enstonces hace fifo
	 * 
	 * @return
	 */
	...
	private static Comparator<Executable> comparatorSPN() {
		return new Comparator<Executable>() {
			@Override
			public int compare(Executable o1, Executable o2) {
				if (o1.totalRanCpuClocks() > o2.totalRanCpuClocks()) // solo
																		// ocurre
																		// en
																		// expel
																		// evaluation
					return 0; // evita expulsion
				return o1.remainingCpuClocks() + o1.totalRanCpuClocks() - o2.remainingCpuClocks()
						+ o2.totalRanCpuClocks();
			}
		};
	}
		...
		return new Comparator<Executable>() {
			...
			public int compare(Executable o1, Executable o2) {
				if (o1.totalRanCpuClocks() > o2.totalRanCpuClocks()) // solo
																		...
																		// evaluation
					return 0; // evita expulsion
				return ((Clock.getInstance().getClock() - o2.getLastClock() + o2.remainingCpuClocks()
						+ o2.totalRanCpuClocks()) / (o2.remainingCpuClocks() + o2.totalRanCpuClocks()))
						- ((Clock.getInstance().getClock() - o1.getLastClock() + o1.remainingCpuClocks()
								+ o1.totalRanCpuClocks()) / (o1.remainingCpuClocks() + o1.totalRanCpuClocks()));
			}
		};
	}
}
